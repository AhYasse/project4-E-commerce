...
const products = [
    new Product(1,'Golden Watch', 400, 'Watches', 'women',  'images/accessories/2809f6567a8309c00022f8e273d8715c.jpg'),
    new Product(2,'Silver necklace', 150, 'Necklace', 'men',  'images/accessories/686d4a051c21359b7577ee191b02fb70.jpg'),
    new Product(3, 'Golden Earrings', 200, 'Earrings', 'women', 'images/accessories/6f5d807b3ac44d8f5fdf2d94f7929177.jpg'),
    new Product(4, 'Black Watch', 350, 'Watches', 'men', 'images/accessories/a959c27ca359e1fc2c5453411253d1ad.jpg'),
    new Product(5, 'Silver Set Rings', 580, 'Rings', 'women', 'images/accessories/dd94301efd4caef4e84229be9a74bf90.jpg'),
    new Product(6, 'Silver necklace', 150, 'Necklace', 'men', 'images/accessories/3ca518ac387b3e07aaf503b2c1399707.jpg'),
    new Product(7, 'Black bracelet', 100, 'Bracelet', 'men', 'images/accessories/ef169eeb1097eaa0cd21f0311524820e.jpg'),
    new Product(8, 'Set Necklace', 500, 'Necklace', 'women', 'images/accessories/9f5a4002bc9bdda21f05e47dc80a38df.jpg'),
    new Product(9, 'Golden set bracelet', 300, 'Bracelet', 'women', 'images/accessories/2a384379039c5e05bd5905edc657e93c.jpg'),
];
...
function renderFavoriteItems() {
    ...
    if (favorites.length === 0) {
        favoriteitemsContainer.innerHTML = '<p class="text-center">You hava no favorite items. </p>';
        return;
    }
            ...
            const cartItem = `
                <div class="cart-item_dd justify-content-between align-items-center mb-2 p-2">
                    <div class="ms-2 d-flex">
                        <h6 class="mb-0">${item.name}</6>
                        <p class="mb-0">Price: $<span id="itemPrice${item.id}"> ${item.price * item.quantity}</span></p>
                        </div>
                    <div class="d-flex align-items-center">
                        <button class="btn btn-sm-outline-secondary" onclick="decreaseQuantity(${item.id})">-</button>
                        <span id="itemQuantity${item.id}" class="mx-2">${item.quantity}</span>
                        <button class="btn btn-sm-outline-secondary" onclick="increaseQuantity(${item.id})">+</button> 
                    </div>
                </div>`;
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if(loggedInUser && isLoggedIn) {
        ...
        // document.getElementById('title').textContent = `Hello ${loggedInUser.firstName}`;
    } else {
    loggedIn = false;
    }
    //--
